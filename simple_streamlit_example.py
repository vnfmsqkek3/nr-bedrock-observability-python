"""
🚀 극도로 단순한 Streamlit + Bedrock + New Relic 모니터링 예제

단 한 줄의 import로 완전한 New Relic 모니터링이 구현됩니다!
...
# 🎯 이 한 줄만으로 모든 Bedrock 호출이 자동으로 New Relic에 전송됩니다!
...
# 자동 패치 활성화
enable_auto_patch(application_name=APP_NAME)
...
def get_bedrock_client():
    """일반적인 boto3.client 호출 - 자동으로 New Relic 모니터링 활성화!"""
...
st.caption("nr-bedrock-observability-python v2.2.0 - 자동 패치 모드")
...
st.markdown("---")
st.markdown(
    "nr-bedrock-observability-python v2.2.0 - 자동 패치 모드"
) 